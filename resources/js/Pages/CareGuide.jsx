                    ...
                    <div className="bg-emerald-950 text-white py-24 md:py-32 relative overflow-hidden">
                        ...
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                            <div className="text-center max-w-5xl mx-auto">
                                <span className="inline-block py-2 px-4 rounded-full bg-emerald-800/80 text-emerald-200 text-sm md:text-base font-bold tracking-widest mb-8 border border-emerald-700/50">
                                    EXPERT AVIAN ADVICE
                                </span>
                                ...
                                <p className="text-xl md:text-3xl text-emerald-100/90 leading-relaxed font-light max-w-4xl mx-auto">
                                    Everything you need to know to build a
                                    happy, healthy, and long-lasting bond with
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                                <div className="lg:col-span-7">
                                    <div className="flex items-center gap-5 mb-8">
                                        ...
                                        <div>
                                            ...
                                            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 font-montserrat mt-1">
                                                Nutrition & Diet
                                            </h2>
                                        </div>
                                    </div>
                                    <p className="text-xl text-gray-600 mb-10 leading-loose">
                                        A balanced diet is the cornerstone of a
                                        healthy parrot. Seed-only diets are
                                        naturally high in fat and low in
                                        essential nutrients, leading to health
                                        complications. We recommend a
                                        scientifically balanced approach:
                                    </p>

                                    <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                                        <ul className="divide-y divide-gray-50">
                                            <li className="p-6 md:p-8 hover:bg-gray-50 transition-colors flex items-start gap-4">
                                                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center font-bold text-lg">
                                                    1
                                                </div>
                                                <div>
                                                    ...
                                                    <p className="text-gray-600 text-lg leading-relaxed">
                                                        ...
                                                        extrusion diets provide
                                                        complete nutrition
                                                        without the "selective
                                                        feeding" of seed mixes.
                                                    </p>
                                                </div>
                                            </li>
                                            <li className="p-6 md:p-8 hover:bg-gray-50 transition-colors flex items-start gap-4">
                                            ...
                                            <li className="p-6 md:p-8 hover:bg-gray-50 transition-colors flex items-start gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-gray-600 text-lg leading-relaxed">
                                                        Use berries, apples (no
                                                        seeds), and mango as
                                                        high-value rewards for
                                ...
                                <div className="lg:col-span-5 h-full flex flex-col gap-6">
                                    <div className="bg-orange-50 rounded-[2.5rem] p-10 flex flex-col items-center justify-center text-center relative overflow-hidden shadow-lg border border-orange-100 flex-grow min-h-[300px]">
                                        ...
                                        <span className="text-9xl mb-6 drop-shadow-sm">
                                            🥕
                                        </span>
                                        ...
                                        <p className="text-orange-800/80 font-medium">
                                            Daily variety prevents boredom.
                                        </p>
                                    </div>
                                    ...
                                    <div className="bg-red-50 rounded-3xl p-8 border border-red-100 shadow-sm relative overflow-hidden">
                                        ...
                                        <div className="relative z-10">
                                            <div className="flex items-center gap-3 mb-4">
                                                ...
                                                <h4 className="text-lg font-bold text-red-900 uppercase tracking-widest">
                                                    Toxic Foods
                                                </h4>
                                            </div>
                                            <p className="text-red-800 text-lg leading-relaxed font-medium">
                                                Avocado, Chocolate, Caffeine,
                                                Alcohol, Onions, Garlic, and
                                                Fruit Seeds.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                                <div className="order-2 lg:order-1 h-full bg-blue-50 rounded-[3rem] p-12 flex items-center justify-center relative overflow-hidden border border-blue-100 shadow-xl group">
                                    ...
                                    <div className="text-center relative z-10 transition-transform duration-500 group-hover:scale-105">
                                        <span className="text-[10rem] leading-none block mb-6 filter drop-shadow-xl">
                                            🏠
                                        </span>
                                        <div className="bg-white/60 backdrop-blur-sm px-8 py-4 rounded-2xl inline-block shadow-sm">
                                            <p className="font-black text-blue-900 uppercase tracking-[0.2em] text-lg">
                                                Safe Haven
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="order-1 lg:order-2">
                                    ...
                                    <p className="text-xl text-gray-600 mb-10 leading-loose">
                                        Your bird's cage is their bedroom, not
                                        their prison. Biggest is always best.
                                        The cage should be large enough for your
                                        bird to fully extend their wings without
                                        touching the sides, at a bare minimum.
                                    </p>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                                            ...
                                            <p className="text-gray-600 leading-relaxed">
                                                Provide variety (natural wood,
                                                manzanita, rope) to prevent foot
                                                sores and arthritis.
                                            </p>
                                        </div>
                                        <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                                            ...
                                            <p className="text-gray-600 leading-relaxed">
                                                Rotate foraging and shredding
                                                toys weekly. Boredom leads to
                                                feather plucking.
                                            </p>
                                        </div>
                                        <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                                            ...
                                            <p className="text-gray-600 leading-relaxed">
                                                Keep away from drafts, direct
                                                sun, and the kitchen (Teflon
                                                fumes are fatal).
                                            </p>
                                        </div>
                                        <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                                            ...
                                            <p className="text-gray-600 leading-relaxed">
                                                Access to full-spectrum UV
                                                lighting is vital for calcium
                                                absorption and mood.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="bg-gradient-to-br from-violet-50 to-purple-50 rounded-[3rem] p-12 lg:p-20 relative overflow-hidden border border-purple-100 shadow-2xl">
                                ...
                                <div className="relative z-10">
                                    <div className="max-w-4xl mx-auto text-center mb-16">
                                        <span className="text-purple-600 font-bold tracking-[0.2em] uppercase text-sm block mb-4">
                                            The Flock Dynamic
                                        </span>
                                        ...
                                        <p className="text-xl md:text-2xl text-gray-600 leading-relaxed font-light">
                                            Parrots are highly social flock
                                            animals. In your home,{" "}
                                            <strong className="text-purple-700 font-bold">
                                                you are their flock
                                            </strong>
                                            . Daily interaction is not optional;
                                            it's a hard requirement for their
                                            mental health.
                                        </p>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                                        <div className="bg-white p-8 rounded-3xl shadow-lg border border-purple-50 hover:-translate-y-2 transition-transform duration-300">
                                            <div className="w-16 h-16 bg-purple-100 text-purple-600 rounded-2xl flex items-center justify-center text-3xl mb-6 mx-auto md:mx-0">
                                                ⏱️
                                            </div>
                                            ...
                                            <p className="text-gray-600 text-lg leading-relaxed">
                                                Aim for at least 2-4 hours of
                                                supervised time outside the cage
                                                daily for exercise and emotional
                                                bonding.
                                            </p>
                                        </div>
                                        <div className="bg-white p-8 rounded-3xl shadow-lg border border-purple-50 hover:-translate-y-2 transition-transform duration-300">
                                            ...
                                            <p className="text-gray-600 text-lg leading-relaxed">
                                                ...
                                                treats. NEVER punish a bird; it
                                                destroys trust and causes
                                                lasting aggression.
                                            </p>
                                        </div>
                                        <div className="bg-white p-8 rounded-3xl shadow-lg border border-purple-50 hover:-translate-y-2 transition-transform duration-300">
                                            ...
                                            <p className="text-gray-600 text-lg leading-relaxed">
                                                Teach tricks, use puzzle
                                                feeders, and talk to your bird
                                                regularly to keep their highly
                                                intelligent mind sharp.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20">
                                <div>
                                    ...
                                    <p className="text-xl text-gray-700 mb-8 leading-loose border-l-4 border-rose-300 pl-6">
                                        Birds are experts at hiding illness—it's
                                        a survival instinct. By the time they
                                        look sick, they are often in critical
                                        condition for hours or days.
                                    </p>
                                    ...
                                    <div className="bg-rose-50 rounded-2xl p-8 border border-rose-100">
                                        ...
                                        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            {[
                                                ...
                                                <li
                                                    key={i}
                                                    className="flex items-center text-gray-800 bg-white px-4 py-3 rounded-lg border border-rose-100 shadow-sm font-medium"
                                                >
                                                    <span className="text-rose-500 mr-3 text-lg">
                                                        ⚠️
                                                    </span>
                                                    {sign}
                                                </li>
                                ...
                                <div className="bg-gray-900 text-white rounded-[2.5rem] p-10 lg:p-14 flex flex-col justify-center text-center shadow-2xl relative overflow-hidden group">
                                    ...
                                    <div className="relative z-10 transition-transform duration-500 group-hover:-translate-y-2">
                                        <h3 className="text-3xl md:text-4xl font-bold mb-6 font-montserrat leading-tight">
                                            Need an Avian Vet?
                                        </h3>
                                        <p className="text-gray-300 mb-10 text-lg leading-relaxed">
                                            Regular check-ups are essential. We
                                            recommend an annual "well-bird" exam
                                            with bloodwork to establish a
                                            baseline for your pet's health.
                                        </p>
                                        <a
                                            href="https://www.aav.org/"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="inline-flex items-center justify-center bg-emerald-500 text-white font-bold py-5 px-10 rounded-full hover:bg-emerald-400 transition shadow-lg hover:shadow-emerald-500/25 text-lg"
                                        >
